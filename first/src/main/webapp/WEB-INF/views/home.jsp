...
.go a {
	...
	<div class="container center-wrapper">
    	<h2 class="page-header">My Community 방문을 환영합니다!</h1>
    	<div class="go">
        	<div class="join"><a href="/join"><i class="fa fa-user-plus fa-fw"></i> 회원가입 바로가기</a></div>
        	<hr>
        	<div class="searchid"><a href="/searchid"><i class="fa fa-user fa-fw"></i> 로그인 바로가기</a></div>
        	<hr>
